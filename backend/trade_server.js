...
export function delete_trade(id) {
    const trade = db.trades[id];
    delete db.trades[id];
    return trade;
}
...
export function leave_trade(id) {
    const trade = db.trades[id];
...
export function add_item_to_trade(id, item) {
    const trade = db.trades[id];
...
export function remove_item_from_trade(id, item) {
    const trade = db.trades[id];
    // check if the ic.caller() is the host or guest
    if (ic.caller() === trade.host) {
...
export function add_item_to_escrow(id, item) {
...
export function remove_item_from_escrow(id, item) {
...
export function get_escrow_items(id) {
    const trade = db.trades[id];
    if (ic.caller() === trade.host) {
...
export function get_escrow_items_self(id) {
    const trade = db.trades[id];
...
export function withdraw_from_escrow(id, item) {
    const trade = db.trades[id];
    let claimedItem;
    if(trade.fulfilled) {
        // TODO: the asset is returned to the user
