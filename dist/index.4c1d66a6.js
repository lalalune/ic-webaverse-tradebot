import { C as k, A as g, t as x, l as P, P as A, d as v, a as D } from "./App.28d22994.js";
const I = async (t) => {
  const { canisterId: o, agent: d, paths: r } = t, c = [...new Set(r)], a = c.map((e) => f(e, o)), n = /* @__PURE__ */ new Map(), m = c.map((e, l) => (async () => {
    var u;
    try {
...
}, w = (t) => x(t), y = (t) => P(new A(t)), b = (t) => v(t), E = (t) => new TextDecoder().decode(t), h = (t) => {
  const o = y(t);
